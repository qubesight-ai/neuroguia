...
export const en: Diccionario = {
  ...
  analizador: {
    titulo: "Situation analyser",
    descripcion:
      "Describe a social situation you want to understand. You will get facts, open questions, possible interpretations and options. You will not get certainties about what another person thinks.",
    etiquetaCampo: "Describe the situation",
    marcador: "For example: someone I talk to stopped replying yesterday and I don't know if I did something wrong.",
    boton: "Analyse my situation",
    analizando: "Analysing the situation...",
    minimo: "Write a little more (at least 20 characters) so the situation can be analysed.",
    errorGenerico: "The analysis could not be completed. You can try again in a moment.",
    errorLimite: "There are many requests right now. Wait a minute and try again.",
    errorCreditos: "The analysis service is unavailable right now.",
    resumen: "In short",
    sabemos: "What we know",
    noSabemos: "What we still don't know",
    interpretaciones: "Possible interpretations",
    posibilidad: "Possibility",
    senales: "Signals that could give you more information",
    opciones: "Options you have",
    beneficio: "Possible benefit",
    inconveniente: "Possible trade-off",
    frase: "A phrase you could use",
    adaptar: "Adapt this phrase",
    adaptarAyuda: "You can edit the phrase here before copying it.",
    recuerda: "Remember",
    seguridad: "Safety",
    relacionadas: "This might also help you",
    nuevo: "Analyse another situation",
    privacidad:
      "Your text is processed to generate the analysis and is not stored on any server. Nothing is kept in a history.",
  },
};
